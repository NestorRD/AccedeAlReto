/*
 * Néstor Romero Díaz
 * Fecha finalización: 10-11-2018
 * Link to challenge: https://www.aceptaelreto.com/problem/statement.php?id=101
 * Programa que definiendo el tamaño de columnas/filas de un cuadrado, introducimos valores y obtenemos si es un cuadrado mágico o no, y si lo es, si es diabolico o diabiolico + esoterico.
 */
package Volumen1;
